...
$aksi="content/mandiri/aksi_mandiri.php";
$syarat=$_GET['id'];
if ($_GET[aksi]=='tambah'){?>
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active"><a href="jkn-mandiri.html">JKN</a></li>
				<li class="active">Daftar Pasien JKN Mandiri</li>
			</ol>
		</div><!--/.row-->
		<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Pendaftaran Pasien JKN Mandiri </h1>
			</div>
		</div><!--/.row-->
		<div class="row">
			<div class="col-md-12">
...
<?php }else{?>
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Daftar Pasien JKN Mandiri <a  href="tambah-jkn-mandiri.html" class="btn btn-primary">Tambah Pasien</a></h1>
			</div>
		</div><!--/.row-->
		<div class="row">
			<div class="col-md-12">
